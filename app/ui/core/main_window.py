...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.processAllImagesButton = QPushButton(self.facesPanelGroupBox)
        self.processAllImagesButton.setObjectName(u"processAllImagesButton")
        self.processAllImagesButton.setFlat(True)
        self.horizontalLayout_4.addWidget(self.processAllImagesButton)
        self.gridLayout_2.addLayout(self.horizontalLayout_4, 0, 0, 1, 1)
        self.horizontalLayout_3 = QHBoxLayout()
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.openOutputFolderButton = QPushButton(self.facesPanelGroupBox)
        self.openOutputFolderButton.setObjectName(u"openOutputFolderButton")
        self.openOutputFolderButton.setFlat(True)
        self.horizontalLayout_3.addWidget(self.openOutputFolderButton)
        ...
        self.advancedEmbeddingEditorButton = QPushButton(self.facesPanelGroupBox)
        self.advancedEmbeddingEditorButton.setObjectName(u"advancedEmbeddingEditorButton")
        self.advancedEmbeddingEditorButton.setFlat(True)
        self.horizontalLayout_3.addWidget(self.advancedEmbeddingEditorButton)
        self.sortEmbeddingsButton = QPushButton(self.facesPanelGroupBox)
        self.sortEmbeddingsButton.setObjectName(u"sortEmbeddingsButton")
        self.sortEmbeddingsButton.setFlat(True)
        self.horizontalLayout_3.addWidget(self.sortEmbeddingsButton)
        ...
        self.batchProgressWidget = QWidget(self.mediaLayout)
        self.batchProgressWidget.setObjectName(u"batchProgressWidget")
        self.batchProgressLayout = QHBoxLayout(self.batchProgressWidget)
        self.batchProgressLayout.setObjectName(u"batchProgressLayout")
        self.batchProgressLabel = QLabel(self.batchProgressWidget)
        self.batchProgressLabel.setObjectName(u"batchProgressLabel")
        self.batchProgressLayout.addWidget(self.batchProgressLabel)
        self.batchProgressBar = QProgressBar(self.batchProgressWidget)
        self.batchProgressBar.setObjectName(u"batchProgressBar")
        self.batchProgressBar.setValue(0)
        self.batchProgressLayout.addWidget(self.batchProgressBar)
        self.cancelBatchButton = QPushButton(self.batchProgressWidget)
        self.cancelBatchButton.setObjectName(u"cancelBatchButton")
        self.batchProgressLayout.addWidget(self.cancelBatchButton)
        self.verticalLayout.addWidget(self.batchProgressWidget)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"VisoMaster Ultimate v8.2", None))
        ...
        self.processAllImagesButton.setText(QCoreApplication.translate("MainWindow", u"Batch Process", None))
#if QT_CONFIG(tooltip)
        self.processAllImagesButton.setToolTip(QCoreApplication.translate("MainWindow", u"Process all items in the target list with current settings", None))
#endif // QT_CONFIG(tooltip)
        self.openOutputFolderButton.setText(QCoreApplication.translate("MainWindow", u"Open Output Dir", None))
#if QT_CONFIG(tooltip)
        self.openOutputFolderButton.setToolTip(QCoreApplication.translate("MainWindow", u"Opens the last used output directory", None))
#endif // QT_CONFIG(tooltip)
        self.inputEmbeddingsSearchBox.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Search Embeddings", None))
        self.advancedEmbeddingEditorButton.setText(QCoreApplication.translate("MainWindow", u"Advanced Editor", None))
        self.sortEmbeddingsButton.setText(QCoreApplication.translate("MainWindow", u"Sorting: Off", None))
#if QT_CONFIG(tooltip)
        ...
        self.cancelBatchButton.setText(QCoreApplication.translate("MainWindow", u"Cancel", None))
